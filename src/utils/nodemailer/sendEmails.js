...
export default async function sendEmails(to, subject, link, attachments = []) {
  ...
  const info = await transporter.sendMail({
    ...
    html: `<div style="width:80%; margin:0 auto; text-align:center; padding:20px; border:1px solid blue; border-radius:10px; background-color:whitesmoke">
             <h1 style="font-weight:900; font-size:30px; color:blue; margin-bottom:20px">${subject} ${link}</h1>
